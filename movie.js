...
all.addEventListener("click", () => {
  //let newmovie = movie.filter((movies) => movies.category === "All");
  show(movie);
});

action.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Action");
  show(newmovie);
});

thriller.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Thriller");
  show(newmovie);
});

animation.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Animation");
  show(newmovie);
});

horror.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Horror");
  show(newmovie);
});

drama.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Drama");
  show(newmovie);
});

sci_Fi.addEventListener("click", () => {
  let newmovie = movie.filter((movies) => movies.category === "Sci-Fi");
  show(newmovie);
});
